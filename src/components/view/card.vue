  ...
  <div class="card" ref='card' v-else>
      ...
      <el-row :span='24'>
        <el-col :span='12' class='buttonDisplay'>
            <el-button type='primary' class='moveButtons' @click='previousInterval' icon='el-icon-d-arrow-left'>
              Previous
            </el-button>
        </el-col>
        <el-col :span='12'>
          <el-row type='flex' justify='end'>
            <el-button type='primary' class='moveButtons' @click='nextInterval' :disabled='!nextExists'>
