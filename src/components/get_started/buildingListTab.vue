      ...
      <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
        <el-steps class="steps" direction="vertical" :space="200">
          <el-step
            status="process"
            title="View All"
            :description="buildingStep1"
          ></el-step>
          <el-step
            status="process"
            title="Category"
            :description="buildingStep2"
          ></el-step>
          <el-step
            status="process"
            title="Search Bar"
            :description="buildingStep3"
          ></el-step>
        </el-steps>
      </el-col>
      <el-col :xs="12" :sm="12" :md="12" :lg="12" :xl="12">
...
export default {
  data () {
    return {
      buildingPic:
        'https://energy-dashboard.s3-us-west-2.amazonaws.com/images/buildingPic.jpg',
      buildingStep1:
      ...
      buildingStep2:
        'Click on a category to see what buildings are in each category.',
      buildingStep3:
