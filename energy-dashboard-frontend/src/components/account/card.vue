...
export default {
  ...
  methods: {
    ...
    save: function () {
      ...
      var groupPoints = []
      for (let i = 0; i < this.$refs.featureController.groupids.length; i++) {
    ...
    download: function () {
      ...
      const points = this.$refs.chartController.points
      const groups = this.$refs.chartController.groups
      const names = this.$refs.chartController.names
      const meters = this.$refs.chartController.submeters
