...
function insertPoint(record, res, meter_id) {
  ...
  //Steam meter
    ...
    query = 'INSERT INTO steam_data (meter_id, time, input, total, minimum, maximum) VALUES ("' + res[0].id + '","' + timestamp + '",' + point[0].$.value + "," + point[1].$.value + "," + point[2].$.value + "," + point[3].$.value + ')';
  ...
  //gas meter
    ...
    query = "INSERT INTO gas_data (meter_id, time, cubic_feet, instantaneous, minimum, maximum, rate) VALUES ('"+ res[0].id+"','" + timestamp + "'," + point[0].$.value + ',' + point[2].$.value +','+ point[3].$.value + ',' + point[4].$.value + ',' + point[1].$.value + ')';
  //h8036
